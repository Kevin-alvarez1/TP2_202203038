...
if (producto == 1){
    totaldesc = precio * cantidad - (0.20*precio*cantidad);
...
public static void ejercicio7(){ 
  ...
  int nelementos =  15;
  int arreglo[] = {6, 10, 5, 4, 2, 0, 11, 7, 39, 3, 1, 8, 94, 22, 95};
for (int i = 0 ; i < (nelementos);i++){
    ...
    System.out.println("narreglo ordenando en forma creciente: ");
    for(int i = 0; i < nelementos; i++){
...
public static void ejercicio8(){
   ...
   Scanner teclado = new Scanner (System.in);
      ...
      if(n%2 == 0){
          int resul = n*n;
          System.out.println("El numero es par por lo tanto el doble es: " +resul);
      }else {
         int result = n*n*n;
          System.out.println("El numero es impar por lo tanto el triple es: "+result);
      }
...
divisor = 2;
    ...
    while (!finished) {
        if(num%divisor == 0){
            num /= divisor;
            System.out.println("encontramos divisor " +String.valueOf(divisor));
        ...
        System.out.println("Error el numero ingresado no esta entre 1 y 1000");
    }
...
public static void ejercicio10(){
   ...
   int base, expo;
   Scanner mamarre = new Scanner(System.in);
    System.out.println("ingrese la base del numero a checar, la base debe estar entre 1 y 10:  ");
base = mamarre.nextInt();
   Scanner marre = new Scanner(System.in);
    System.out.println("ingrese el exponente del numero a checar, el exponente debe estar entre 1 y 4:  ");
expo = marre.nextInt();
if (base >=1 && base <= 10 && expo >= 1 && expo <= 4){
    int result = (int)Math.pow(base, expo);
        JOptionPane.showMessageDialog(null, "el resultado de su operacion es: "+result);

}
else{
   JOptionPane.showMessageDialog(null,"Los numeros ingresados no cumplen con los parametros, tiene 1 intento más para introducirlos de manera correcta ","error",JOptionPane.ERROR_MESSAGE);
    System.out.println("ingrese la base del numero a checar, la base debe estar entre 1 y 10:  ");
base = mamarre.nextInt();
    System.out.println("ingrese el exponente del numero a checar, el exponente debe estar entre 1 y 4:  ");
expo = marre.nextInt();
